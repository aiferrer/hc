...
class RegistrarProductoModel extends FlutterFlowModel {
  ...
  FormFieldController<String>? dropDownMonedaProdValueController;
  ...
  FormFieldController<String>? dropDownCategoriaProdValueController;
  // State field(s) for DropDown_EstadoProd widget.
  String? dropDownEstadoProdValue;
  FormFieldController<String>? dropDownEstadoProdValueController;
