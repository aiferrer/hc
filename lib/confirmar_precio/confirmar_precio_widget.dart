...
import 'confirmar_precio_model.dart';
export 'confirmar_precio_model.dart';

class ConfirmarPrecioWidget extends StatefulWidget {
  const ConfirmarPrecioWidget({Key? key}) : super(key: key);

  @override
  _ConfirmarPrecioWidgetState createState() => _ConfirmarPrecioWidgetState();
}

class _ConfirmarPrecioWidgetState extends State<ConfirmarPrecioWidget> {
  late ConfirmarPrecioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfirmarPrecioModel());
    ...
    return StreamBuilder<List<ProductoRecord>>(
      stream: queryProductoRecord(
        queryBuilder: (productoRecord) => productoRecord
            .where('Estado_Proceso', isEqualTo: 'Tasar')
            .orderBy('Descripcion'),
      ),
      builder: (context, snapshot) {
        ...
        List<ProductoRecord> confirmarPrecioProductoRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        child: Padding(
                          ...
                          child: Autocomplete<String>(
                            ...
                            optionsBuilder: (textEditingValue) {
                              ...
                              return confirmarPrecioProductoRecordList
                                  .map((e) => e.descripcion)
                                  .withoutNulls
                                  .toList()
                                  .toList()
                            ...
                            onSelected: (String selection) {
                              setState(() =>
                                  _model.textFieldBuscarProductoSelectedOption =
                                      selection);
                                  ...
                                  () async {
                                    setState(() {
                                      _model.simpleSearchResults = TextSearch(
                                        confirmarPrecioProductoRecordList
                                            .map(
                    ...
                    child: Builder(
                      builder: (context) {
                        final productosNoSearch =
                            confirmarPrecioProductoRecordList.toList();
