...
import 'buscar_prod_model.dart';
export 'buscar_prod_model.dart';

class BuscarProdWidget extends StatefulWidget {
  const BuscarProdWidget({
    Key? key,
    this.parameter1,
    this.parameter2,
  }) : super(key: key);
  ...
  @override
  _BuscarProdWidgetState createState() => _BuscarProdWidgetState();
}

class _BuscarProdWidgetState extends State<BuscarProdWidget> {
  late BuscarProdModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuscarProdModel());
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    context.pushNamed('Registrar_Producto');
                  },
                ),
              ],
            ),
          ...
          if (!FFAppState().searchActive)
            Padding(
              ...
              child: Builder(
                builder: (context) {
                  final productosNoSearch = widget.parameter2?.toList() ?? [];
