...
import 'cliente_a_facturar_model.dart';
export 'cliente_a_facturar_model.dart';

class ClienteAFacturarWidget extends StatefulWidget {
  const ClienteAFacturarWidget({Key? key}) : super(key: key);

  @override
  _ClienteAFacturarWidgetState createState() => _ClienteAFacturarWidgetState();
}

class _ClienteAFacturarWidgetState extends State<ClienteAFacturarWidget> {
  late ClienteAFacturarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClienteAFacturarModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ClienteRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClienteRecord> clienteAFacturarClienteRecordList = snapshot.data!;
                            ...
                            child: Padding(
                              ...
                              child: Autocomplete<String>(
                                ...
                                optionsBuilder: (textEditingValue) {
                                  ...
                                  return clienteAFacturarClienteRecordList
                                      .map((e) => e.nombre)
                                      .toList()
                                      .where((option) {
                                      ...
                                      () async {
                                        setState(() {
                                          _model
                                            ...
                                            clienteAFacturarClienteRecordList
                                                .map(
                        ...
                        child: Builder(
                          builder: (context) {
                            final clientesNoSearch =
                                clienteAFacturarClienteRecordList.toList();
